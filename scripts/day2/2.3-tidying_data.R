...
# Manipulate these two tables to be identical to `tidyr::table1`
table4a
table4b

# Recall that we have datasets to choose from from the nyc flights package:
flights2
airlines
weather2
planes
...
# How many different planes (i.e. "tailnum"s) fly out of EWR airport?
# **Important: "year" in planes means manufacture year, and in flights2 it means the year of the flight.**


# Filter flights2 to only include flights that **don't** have weather information available


# How many flights proceeded from each airport with visibility < 1?
